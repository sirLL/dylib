...
import cn.dianyinhuoban.hm.mvp.bean.MemberRank
...
class TeamMemberRankAdapter : BaseAdapter<MemberRank, RecyclerView.ViewHolder>() {
...
//            }
    ...
    private fun bindHeaderData(holder: HeaderViewHolder) {
        var no1: MemberRank? = null
        var no2: MemberRank? = null
        var no3: MemberRank? = null
        if (mData != null) {
            if (mData.size > 0) {
                no1 = mData[0]
            }
        ...
        holder.tvAmountNo1.text = if (no1 == null) {
            ...
            NumberUtils.formatMoney(no1.personal)
        }
        ...
        holder.tvAmountNo2.text = if (no2 == null) {
            ...
            NumberUtils.formatMoney(no2.personal)
        }
        ...
        holder.tvAmountNo3.text = if (no3 == null) {
            ...
            NumberUtils.formatMoney(no3.personal)
        }
    }
