...
import com.dy.tablayout.listener.OnTabSelectListener;
import com.dy.tablayout.utils.FragmentChangeManager;
import com.dy.tablayout.utils.UnreadMsgUtils;
import com.dy.tablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    /** 关联数据支持同时切换fragments */
    public void setTabData(ArrayList<CustomTabEntity> tabEntitys, FragmentManager fa, int containerViewId, ArrayList<Fragment> fragments) {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                tabView = View.inflate(mContext, R.layout.dy_layout_tab_left, null);
            } else if (mIconGravity == Gravity.RIGHT) {
                tabView = View.inflate(mContext, R.layout.dy_layout_tab_right, null);
            } else if (mIconGravity == Gravity.BOTTOM) {
                tabView = View.inflate(mContext, R.layout.dy_layout_tab_bottom, null);
            } else {
                tabView = View.inflate(mContext, R.layout.dy_layout_tab_top, null);
            }
